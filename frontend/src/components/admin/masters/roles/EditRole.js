...
class EditRole extends Component {   
   ...
   constructor(props) {
    ...
    this.state = {role_id: '', role_name: '',status: ''};
   ...
   let url = process.env.REACT_APP_BACKEND_BASE_URL +'admin/masters/roles/get/'+this.props.match.params.id;
    axios.get(url)
    .then(response => { 
      
      this.setState({ 
          role_id: response.data.data.role_id, role_name: response.data.data.role_name, status: response.data.data.status 
        }); 
   ...
   onSubmit(e) {
    ...
    let uri = process.env.REACT_APP_BACKEND_BASE_URL +'admin/masters/roles/update/'+roles_data.role_id;    
                  ...
                  <div className="container-fluid">
                    <div className="row mb-2">
                      <div className="col-sm-6">
                        <h5 className="m-0 text-dark">Edit Role</h5>
                      </div>{/* /.col */}
                      <div className="col-sm-6">
