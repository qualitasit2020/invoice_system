...
class EditCountry extends Component {   
   ...
   constructor(props) {
    ...
    this.state = {country_id: '', country_name: '',status: ''};
   ...
   let url = process.env.REACT_APP_BACKEND_BASE_URL +'admin/masters/countries/get/'+this.props.match.params.id;
    axios.get(url)
    .then(response => { 
      
      this.setState({ 
          country_id: response.data.data.country_id, country_name: response.data.data.country_name, status: response.data.data.status 
        }); 
   ...
   onSubmit(e) {
    ...
    let uri = process.env.REACT_APP_BACKEND_BASE_URL +'admin/masters/countries/update/'+countries_data.country_id;    
                  ...
                  <div className="container-fluid">
                    <div className="row mb-2">
                      <div className="col-sm-6">
                        <h5 className="m-0 text-dark">Edit Country</h5>
                      </div>{/* /.col */}
                      <div className="col-sm-6">
