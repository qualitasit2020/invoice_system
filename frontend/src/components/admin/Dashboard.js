                  ...
                  <div className="container-fluid">
                    <div className="row mb-2">
                      <div className="col-sm-6">
                        <h5 className="m-0 text-dark">Dashboard</h5>
                      </div>{/* /.col */}
                      <div className="col-sm-6">
            ...
            <div className="row">
              ...
              <div className="col-md-8">
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="card">
                      ...
                      <div className="card-footer text-center">
                        <a href={void(0)} >View All Users</a>
                      </div>
                      {/* /.card-footer */}
                    </div>
                    {/*/.card */}
                ...
                <div className="card">
                  ...
                  <div className="card-footer clearfix">
                    <a href="" onClick={e => { e.preventDefault() }} className="btn btn-sm btn-info float-left">Place New Order</a>
                    <a href="" onClick={e => { e.preventDefault() }} className="btn btn-sm btn-secondary float-right">View All Orders</a>
                  </div>
                  {/* /.card-footer */}
                </div>
                {/* /.card */}
              ...
              <div className="col-md-4">
                ...
                <div className="card">
                    ...
                    <ul className="products-list product-list-in-card pl-2 pr-2">
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a href="" onClick={e => { e.preventDefault() }} className="product-title">Samsung TV
                      ...
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a href="" onClick={e => { e.preventDefault() }} className="product-title">Bicycle
                      ...
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a href="" onClick={e => { e.preventDefault() }} className="product-title">
                      ...
                      <li className="item">
                        ...
                        <div className="product-info">
                          <a href="" onClick={e => { e.preventDefault() }} className="product-title">PlayStation 4
                  ...
                  {/* /.card-body */}
                  <div className="card-footer text-center">
                    <a href="" onClick={e => { e.preventDefault() }} className="uppercase">View All Products</a>
                  </div>
                  {/* /.card-footer */}
                </div>
                {/* /.card */}
